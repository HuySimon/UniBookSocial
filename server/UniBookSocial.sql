...
VALUES (
        2,
        1,
        'Tài liệu không giống ảnh',
        '2023-10-06 07:47:01',
        '2023-10-06 07:47:01'
    ), (
        10,
        4,
        'Tài liệu mờ một số trang',
        '2023-10-06 07:49:36',
        '2023-10-06 07:49:36'
    ), (
        12,
...
VALUES (
        ...
        'Anh Huy Nguyễn',
        'avatarDefault.png',
        'coverImageDefault.png',
        '$2a$12$Xq4zp77n9017vz3FZ55GZOR6IqM/rjojmma5TSOKAxwKwPYeN8VV2',
        'Active',
        2,
        NULL,
        NULL,
...
ALTER TABLE
    `notifications` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 7;
...
ALTER TABLE
    `permissions` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 8;
...
ALTER TABLE
    `posts` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 11;
...
ALTER TABLE
    `reviews` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 2;
...
ALTER TABLE
    `roles` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;
