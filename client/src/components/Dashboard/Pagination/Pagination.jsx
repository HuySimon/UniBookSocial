      ...
      paginationItems.push(
        <p
          ...
          className={`text-sm font-medium leading-none cursor-pointer border-t pt-3 mr-4 px-2 ${
            pageNumber === currentPage ? 'text-indigo-700 border-indigo-400' : 'text-gray-600 hover:text-indigo-700 border-transparent hover:border-indigo-400'
          }`}
  ...
  return ( 
      <div className="flex items-center justify-center py-10 lg:px-0 sm:px-6 px-4">
        ...
        <div className="lg:w-3/5 w-full  flex items-center justify-between border-t border-gray-200">
            <div className={`flex items-center pt-3 text-gray-600 ${currentPage === 1 ? '' : 'hover:text-indigo-700 cursor-pointer' }`} onClick={() => handlePrevious()}>
            ...
            <div className={`flex items-center pt-3 text-gray-600 ${currentPage === totalPages ? '' : 'hover:text-indigo-700 cursor-pointer'}`} onClick={() => handleNext()}>
