            ...
            >
                <div className="relative w-full h-full flex flex-col items-stretch">
                    <div className="navbar-logo h-16 !ml-0 my-4">
                        <Link className="flex justify-center items-center w-full grow-0 shrink-0" to={'/'}>
                            <img src={Logo} alt="" className="w-12 h-14 object-contain" />
                            <span
                                className={`font-bold text-2xl overflow-hidden transition-all ml-2 ${
                                    expand ? 'w-44' : 'w-0'
                                }`}
                            >
                                SGU School
                        ...
                        {localStorage.getItem('auth') === 'true' && localStorage.getItem('user') != '' && (
                            <>
                                <SideBarItem
                                    ...
                                    expand={expand}
                                    handleCreate={() => {
                                        setIsVisibleNotify(!isVisibleNotify);
                                    }}
                                ...
                                <SideBarItem
                                    ...
                                    icon={
                                        <img src={Portrait} className="w-[30px] h-[30px] rounded-full object-cover" />
                                    }
                                />
                            </>
                        )}
