					...
					<div className="py-4 flex border-b border-gray-400">
						...
						<div className="flex flex-col justify-between gap-4 ml-5">
							...
							<div className="flex justify-between items-center gap-5">
								<input tabIndex={4} type="number" name="price-min" id="" className="px-3 py-2 rounded-md" />
								<span> - </span>
								<input tabIndex={5} type="number" name="price-max" id="" className="px-3 py-2 rounded-md" />
							</div>
						</div>
					</div>
				</form>
