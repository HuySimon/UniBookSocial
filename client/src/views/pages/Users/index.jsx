...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div className="flex items-center pb-4 pt-20 bg-white ">
        <div className='ml-2'>
    ...
    <table className="w-full text-sm text-left text-gray-500 -400">
        ...
        <tbody>
            <tr className="bg-white border-b -800 -700 hover:bg-gray-50 -gray-600">
                ...
                <td className="px-6 py-4">
                    <a href="#" className="font-medium text-blue-600 -500 hover:underline">Edit user</a>
                </td>
            </tr>
            <tr className="bg-white border-b -800 -700 hover:bg-gray-50 -gray-600">
            ...
            <tr className="bg-white -800 hover:bg-gray-50 -gray-600">
                <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
