            ...
            <motion.div
                ...
                <div className={`w-full md:w-1/2 xl:w-[40%] py-16 px-8 md:p-16 text-primary-main transition-all duration-1000 relative`}>
                    ...
                    <form
                        ...
                        <button
                            type="submit"
                            className='w-full py-3 px-14 font-semibold rounded-lg bg-primary-main border transition-all duration-300 border-primary-main hover:bg-transparent hover:text-primary-main text-white shadow-md !shadow-primary-400'>
                            Login
                        </button>
                        <div className="flex my-4">
                            ...
                            <Link
                                to={"/signup"}
                                className='ml-1 font-semibold text-primary-main'>Create an account</Link>
                        </div>
                        <div className="flex flex-col justify-center items-center gap-3 mt-2 w-full">
                            <p className='text-primary-500'>Or, login with</p>
                            <Link
