        ...
        <section
            ...
            <motion.div
                    ...
                    <form
                        ...
                        <div className="flex flex-col mb-3">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                className='border border-primary-300 rounded-md text-primary-main placeholder:text-primary-700 placeholder:text-sm px-4 py-2 w-full' placeholder='Enter your email' />
                        </div>
                        <div className="flex flex-col relative mb-3">
                            ...
                            <input type={`${!showPassword ? "password" : "text"}`} name="password" id="password"
                                ...
                                className='border border-primary-300 rounded-md text-primary-main placeholder:text-primary-700 placeholder:text-sm px-4 py-2 w-full' placeholder='Enter your password' />
                            {
                                !showPassword ? (
                                    <PiEyeBold
                        ...
                        <div className="flex flex-col relative">
                            <label htmlFor="password" className='font-semibold mb-1'>Confirm Password</label>
                            <input type={`${!showPassword ? "password" : "text"}`} name="password" id="password"
                                value={password}
                                onChange={(e) => setPassword(e.target.value)}
                                className='border border-primary-300 rounded-md text-primary-main placeholder:text-primary-700 placeholder:text-sm px-4 py-2 w-full' placeholder='Enter your password' />
                        ...
                        <button
                            type="submit"
                            className='w-full py-3 px-14 font-semibold rounded-lg bg-primary-main border transition-all duration-300 border-primary-main hover:bg-transparent hover:text-primary-main text-white shadow-md !shadow-primary-400 mt-5'>
                            Sign up
                        </button>
                        <div className="flex my-4">
                            ...
                            <Link
                                to={"/login"}
                                className='ml-1 font-semibold text-primary-main'>Login here</Link>
                        </div>
                ...
                <div className="hidden md:block md:w-1/2 xl:w-[60%] p-3 z-10">
                    <img src={SignupImg} alt="" className='rounded-2xl w-full h-full xl:object-none object-cover' />
                </div>
            </motion.div>
        </section>
    )
